// benchmarks/epoll_throughput_bench.cc - Epoll throughput benchmark
...
// Benchmark
// ============================================================================
BenchmarkResult run_epoll_benchmark() {
    std::cout << "\n--- Epoll Throughput Benchmark ---" << std::endl;
    ...
    for (int i = 0; i < NUM_CLIENTS; ++i) {
        threads.emplace_back(echo_client, i);
    }
    ...
    BenchmarkResult result{"Epoll Reactor"};
...
int main() {
    std::cout << "=== Epoll Throughput Benchmark ===" << std::endl;

    try {
        auto result = run_epoll_benchmark();
        result.print();
